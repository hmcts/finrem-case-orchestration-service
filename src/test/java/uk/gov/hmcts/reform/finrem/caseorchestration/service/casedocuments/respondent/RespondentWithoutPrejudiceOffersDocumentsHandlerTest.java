...
public class RespondentWithoutPrejudiceOffersDocumentsHandlerTest extends BaseManageDocumentsHandlerTest {

    @InjectMocks
    RespondentWithoutPrejudiceOffersDocumentHandler collectionService;
