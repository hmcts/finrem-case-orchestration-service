...
public class ListForHearingMidEventHandlerTest {
    ...
    @InjectMocks
    private ListForHearingMidEventHandler listForHearingMidEventHandler;

    @Test
    public void givenCallbackCanBeHandledCreateCase_whenCanHandleCalled_thenReturnTrue() {
        assertThat(listForHearingMidEventHandler
    ...
    public void givenValidRequest_whenHandle_thenReturnExpectedResponse() {
        ...
        AboutToStartOrSubmitCallbackResponse response = listForHearingMidEventHandler.handle(callbackRequest, AUTH_TOKEN);
