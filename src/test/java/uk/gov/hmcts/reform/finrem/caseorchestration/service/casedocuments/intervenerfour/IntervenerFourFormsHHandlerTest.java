...
public class IntervenerFourFormsHHandlerTest extends BaseManageDocumentsHandlerTest {
    ...
    public void givenAddedDocOnScreenCollectionWhenAddNewOrMovedDocumentToCollectionThenAddScreenDocsToCollectionType() {
        ...
        assertThat(caseData.getUploadCaseDocumentWrapper()
                .getDocumentCollectionPerType(ManageCaseDocumentsCollectionType.INTV_FOUR_FORMS_H_COLLECTION),
            hasSize(1));
