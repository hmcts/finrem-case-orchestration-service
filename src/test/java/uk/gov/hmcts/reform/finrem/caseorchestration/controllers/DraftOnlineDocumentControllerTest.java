...
public class DraftOnlineDocumentControllerTest extends BaseControllerTest {
    ...
    @MockBean
    protected FinremCallbackRequestDeserializer deserializer;
    ...
    public OngoingStubbing<Document> whenServiceGeneratesDocument() {
        return when(documentService.generateDraftContestedMiniFormA(eq(AUTH_TOKEN), isA(FinremCaseDetails.class)));
    }
