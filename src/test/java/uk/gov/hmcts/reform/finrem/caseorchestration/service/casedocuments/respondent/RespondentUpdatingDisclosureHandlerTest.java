...
public class RespondentUpdatingDisclosureHandlerTest
    extends UpdatingDisclosureHandlerTest {

    @InjectMocks
    private RespondentUpdatingDisclosureHandler respondentUpdatingDisclosureHandler;
    ...
    @Override
    public RespondentUpdatingDisclosureHandler getDocumentHandler() {
        return respondentUpdatingDisclosureHandler;
    }
    ...
    protected CaseDocumentParty getCaseDocumentParty() {
        return CaseDocumentParty.RESPONDENT;
    }
