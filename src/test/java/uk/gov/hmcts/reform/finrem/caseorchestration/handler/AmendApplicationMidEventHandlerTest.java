...
public class AmendApplicationMidEventHandlerTest {
    ...
    @InjectMocks
    private AmendApplicationMidEventHandler amendApplicationMidEventHandler;

    private CallbackRequest callbackRequest;

    @Test
    public void givenCallbackCanBeHandledCreateCase_whenCanHandleCalled_thenReturnTrue() {
        assertThat(amendApplicationMidEventHandler
    ...
    public void givenValidRequest_whenHandle_thenReturnExpectedResponse() {
        ...
        AboutToStartOrSubmitCallbackResponse response = amendApplicationMidEventHandler.handle(callbackRequest, AUTH_TOKEN);
