...
public class UpdateFrcInformationMidEventHandlerTest {
    ...
    @InjectMocks
    private UpdateFrcInformationMidEventHandler updateFrcInformationMidEventHandler;

    @Test
    public void givenCallbackCanBeHandledCreateCase_whenCanHandleCalled_thenReturnTrue() {
        assertThat(updateFrcInformationMidEventHandler
    ...
    public void givenCallbackCannotBeHandledBadCaseType_whenCanHandleCalled_thenReturnFalse() {
        assertThat(updateFrcInformationMidEventHandler
                .canHandle(CallbackType.MID_EVENT, CaseType.CONSENTED, EventType.UPDATE_FRC_INFORMATION),
            is(false));
    }
    ...
    public void givenValidRequest_whenHandle_thenReturnExpectedResponse() {
        ...
        AboutToStartOrSubmitCallbackResponse response = updateFrcInformationMidEventHandler.handle(callbackRequest, AUTH_TOKEN);
