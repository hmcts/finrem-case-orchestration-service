...
public class TestConstants {
    ...
    public static final String TEST_ORG2_ID = "test.org2.id";
    ...
    public static final String TEST_HEARING_TYPE = "hearingType";
    ...
    public static final Long CASE_ID_IN_LONG = 1234567890L;
    ...
    public static final String TEST_RESP_SOLICITOR_REFERENCE = "RG-987654321";
