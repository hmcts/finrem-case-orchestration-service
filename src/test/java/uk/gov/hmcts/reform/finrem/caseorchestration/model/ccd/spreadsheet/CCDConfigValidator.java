...
public class CCDConfigValidator {
    ...
    private final List<String> ccdFieldsTypeToIgnore = List.of("Label", "OrderSummary", "CaseHistoryViewer",
        "CasePaymentHistoryViewer", "FlagLauncher", "ComponentLauncher", "SearchCriteria");
    ...
    private final List<String> finremCaseDataFieldsToIgnore =
        List.of("ccdCaseId", "courtDetails", "d11", "isCfvCategoriesAppliedFlag", "orderSummary");
    ...
    private boolean doesNotMatchFieldSimpleName(String expectedClassSimpleName, Class clazz) {
        return !expectedClassSimpleName.toLowerCase().equals(clazz.getSimpleName().toLowerCase());
    }
