...
import uk.gov.hmcts.reform.finrem.caseorchestration.service.bulkscan.BulkScanService;
...
public class BulkScanControllerTest {
    ...
    public void shouldReturnValidatorResults() throws UnsupportedFormTypeException {
        ...
        when(bulkScanService.validateBulkScanForm(
            ArgumentMatchers.eq(TEST_FORM_TYPE),
