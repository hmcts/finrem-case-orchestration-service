...
public class EmailTemplateNamesTest {
    ...
    public void givenJvmIsWorkingAccordingToSpecification_whenEnumNameInvoked_thenItReturnsSameStringAsEnumName() {
        ImmutableMap.<Enum, String>builder()
            ...
            .put(FR_CONSENT_ORDER_NOT_APPROVED_SENT_APPLICANT, "FR_CONSENT_ORDER_NOT_APPROVED_SENT_APPLICANT")
            .put(FR_CONSENT_ORDER_NOT_APPROVED_SENT_RESPONDENT, "FR_CONSENT_ORDER_NOT_APPROVED_SENT_RESPONDENT")
