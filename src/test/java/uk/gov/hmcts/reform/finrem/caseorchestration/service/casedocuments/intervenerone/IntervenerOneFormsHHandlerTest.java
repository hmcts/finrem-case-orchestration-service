...
public class IntervenerOneFormsHHandlerTest extends FormsHHandlerTest {
    ...
    public void assertCorrectCategoryAssignedFromDocumentType() {
        assertThat(
            handler.getDocumentCategoryFromDocumentType(CaseDocumentType.FORM_H, CaseDocumentParty.INTERVENER_ONE),
            is(DocumentCategory.HEARING_DOCUMENTS_INTERVENER_1_COSTS_ESTIMATES_OR_FORM_H_OR_FORM_H1)
        );
    }
}
