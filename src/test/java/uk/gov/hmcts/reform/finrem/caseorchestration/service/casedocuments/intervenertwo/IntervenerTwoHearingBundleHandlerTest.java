...
public class IntervenerTwoHearingBundleHandlerTest extends BaseManageDocumentsHandlerTest {
    ...
    public void givenAddedDocOnScreenCollectionWhenAddNewOrMovedDocumentToCollectionThenAddScreenDocsToCollectionType() {
        ...
        assertThat(caseData.getUploadCaseDocumentWrapper()
                .getDocumentCollectionPerType(ManageCaseDocumentsCollectionType.INTV_TWO_HEARING_BUNDLES_COLLECTION),
            hasSize(1));
