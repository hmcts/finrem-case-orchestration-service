...
class PdfDocumentReaderTest {
    ...
    @InjectMocks
    private PdfDocumentReader underTest;

    @BeforeEach
    public void setUp() {
        underTest = new PdfDocumentReader();
    }
    ...
    void testGetContentFromADocxFile() throws IOException {
        ...
        assertThat(underTest.getContent(document)).containsAnyOf("1. The applicant is Doris Duck",
            "In the Family Court Case No: 1708940824018030");
    }
    ...
    void testGetContent_withError() throws IOException {
        ...
        assertThatThrownBy(() -> underTest.getContent(document)).isInstanceOf(IOException.class);
    }
}
