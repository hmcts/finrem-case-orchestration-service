...
class FinremCaseDetailMapperTest {
    ...
    private void assertEnums(FinremCaseData caseData) {
        ...
        assertEquals(AuthorisationSignedBy.LITIGATION_FRIEND, caseData.getAuthorisationDetailsWrapper()
            .getAuthorisationSignedBy());
        ...
        assertEquals(JudgeType.HER_HONOUR_JUDGE, caseData.getRefusalOrderWrapper().getRefusalOrderJudgeType());
        ...
        assertEquals(StageReached.DECREE_NISI, caseData.getDivorceDetailsWrapper().getDivorceStageReached());
    ...
    private void assertIndividualDocuments(FinremCaseData caseData) {
        ...
        assertEquals(caseData.getDivorceDetailsWrapper().getDivorceUploadEvidence1(), getTestDocument());
        assertEquals(caseData.getDivorceDetailsWrapper().getDivorceUploadEvidence2(), getTestDocument());
