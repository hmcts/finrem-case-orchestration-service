...
public class UpdateCourtInfoMidEventHandlerTest {
    ...
    @InjectMocks
    private UpdateCourtInfoMidEventHandler updateCourtInfoMidEventHandler;

    private CallbackRequest callbackRequest;

    @Test
    public void givenCallbackCanBeHandledCreateCase_whenCanHandleCalled_thenReturnTrue() {
        assertThat(updateCourtInfoMidEventHandler
    ...
    public void givenCallbackCannotBeHandledBadCallbackType_whenCanHandleCalled_thenReturnFalse() {
        assertThat(updateCourtInfoMidEventHandler
                .canHandle(CallbackType.ABOUT_TO_SUBMIT, CaseType.CONSENTED, EventType.CONSENTED_UPDATE_COURT_INFO),
            is(false));
    }
    ...
    public void givenCallbackCannotBeHandledBadCaseType_whenCanHandleCalled_thenReturnFalse() {
        assertThat(updateCourtInfoMidEventHandler
                .canHandle(CallbackType.MID_EVENT, CaseType.CONTESTED, EventType.CONSENTED_UPDATE_COURT_INFO),
            is(false));
    }
    ...
    public void givenValidRequest_whenHandle_thenReturnExpectedResponse() {
        ...
        AboutToStartOrSubmitCallbackResponse response = updateCourtInfoMidEventHandler.handle(callbackRequest, AUTH_TOKEN);
