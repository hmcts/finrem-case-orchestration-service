...
public abstract class BaseServiceTest extends BaseTest {
    ...
    protected OldCallbackRequest getConsentedCallbackRequestForVariationOrder() {
        Map<String, Object> caseData = new HashMap<>();
        ...
        List<String> natureOfApplication =  List.of("Lump Sum Order",
            ...
            "Property Adjustment Order");
        caseData.put("natureOfApplication2", natureOfApplication);
        return OldCallbackRequest.builder()
    ...
    protected OldCallbackRequest getConsentedCallbackRequest() {
        Map<String, Object> caseData = new HashMap<>();
        caseData.put(SOLICITOR_EMAIL, TEST_SOLICITOR_EMAIL);
        caseData.put(CONSENTED_SOLICITOR_NAME, TEST_SOLICITOR_NAME);
        caseData.put(SOLICITOR_REFERENCE, TEST_SOLICITOR_REFERENCE);
    ...
    protected CallbackRequest getConsentedNewCallbackRequest() {
        FinremCaseData caseData = new FinremCaseData();
    ...
    protected OldCallbackRequest getContestedCallbackRequest() {
    ...
    protected CallbackRequest getContestedNewCallbackRequest() {
    ...
    protected OldCallbackRequest getContestedCallbackRequestWithCaseDataValues(Map<String, Object> caseDataValuesToAdd) {
        Map<String, Object> caseData = getCaseData();
