...
import static uk.gov.hmcts.reform.finrem.caseorchestration.service.noc.letters.generators.NocLetterDetailsGenerator.LETTER_DATE_FORMAT;
...
public class NocLetterDetailsGeneratorTest {
    ...
    @Mock
    private AddresseeBuilderService addresseeBuilder;
    @Mock
    ...
    public void setUpTest() {
        ...
        when(addresseeBuilder.buildAddressee(caseDetails, DocumentHelper.PaperNotificationRecipient.APPLICANT)).thenReturn(
