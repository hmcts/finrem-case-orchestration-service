...
public class IntervenerFourCaseSummariesHandlerTest extends CaseSummariesHandlerTest {
    ...
    public void assertCorrectCategoryAssignedFromDocumentType() {
        assertThat(
            handler.getDocumentCategoryFromDocumentType(CaseDocumentType.POSITION_STATEMENT, CaseDocumentParty.INTERVENER_FOUR),
            is(DocumentCategory.HEARING_DOCUMENTS_INTERVENER_4_POSITION_STATEMENT)
        );

        assertThat(
            handler.getDocumentCategoryFromDocumentType(CaseDocumentType.SKELETON_ARGUMENT, CaseDocumentParty.INTERVENER_FOUR),
