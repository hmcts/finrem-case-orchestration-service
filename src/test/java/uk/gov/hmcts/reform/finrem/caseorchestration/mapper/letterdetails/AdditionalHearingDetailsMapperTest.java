...
import uk.gov.hmcts.reform.finrem.caseorchestration.mapper.letterdetails.additionalhearing.AdditionalHearingDetails;
...
public class AdditionalHearingDetailsMapperTest extends AbstractLetterDetailsMapperTest {
    ...
    @Before
    public void setUp() {
        setCaseDetails(BULK_PRINT_ADDITIONAL_HEARING_JSON);
    }
