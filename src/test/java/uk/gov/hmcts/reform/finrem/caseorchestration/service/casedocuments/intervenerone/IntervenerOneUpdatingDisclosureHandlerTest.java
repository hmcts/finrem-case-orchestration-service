...
public class IntervenerOneUpdatingDisclosureHandlerTest
    extends UpdatingDisclosureHandlerTest {

    @InjectMocks
    private IntervenerOneUpdatingDisclosureHandler intervenerOneUpdatingDisclosureHandler;
    ...
    @Override
    public IntervenerOneUpdatingDisclosureHandler getDocumentHandler() {
        return intervenerOneUpdatingDisclosureHandler;
    }
    ...
    protected CaseDocumentParty getCaseDocumentParty() {
        return CaseDocumentParty.INTERVENER_ONE;
    }
