...
public class IntervenerThreeWithoutPrejudiceOffersDocumentsHandlerTest extends BaseManageDocumentsHandlerTest {

    @InjectMocks
    IntervenerThreeWithoutPrejudiceOffersDocumentHandler collectionService;


    @Override
    public void setUpscreenUploadDocumentList() {
        screenUploadDocumentList.add(createContestedUploadDocumentItem(CaseDocumentType.WITHOUT_PREJUDICE_OFFERS,
            CaseDocumentParty.INTERVENER_THREE, YesOrNo.NO, YesOrNo.NO, "Other Example"));
    }
