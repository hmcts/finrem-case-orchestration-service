...
class FormerIntervenerFourSolicitorListenerTest extends BasePartyListenerTest {

    @InjectMocks
    private FormerIntervenerFourSolicitorListener underTest;
