...
class GeneralApplicationWrapperPopulatorTest {
    ...
    @TestLogs
    private final TestLogger logger = new TestLogger(GeneralApplicationWrapperPopulator.class);
    ...
    void shouldPopulateCaseDataCorrectly() {
        ...
        GeneralApplicationRegionWrapper generalApplicationRegionWrapper = mock(GeneralApplicationRegionWrapper.class);
        FinremCaseData caseData = FinremCaseData.builder()
            .generalApplicationWrapper(generalApplicationWrapper)
