...
class StopRepresentingClientAboutToStartHandlerTest {
    ...
    void givenAsApplicantSolicitor_whenHandled_thenSessionWrapperPopulated() {
        ...
        assertThat(finremCaseData.getSessionWrapper().getLoginAsRespondentSolicitor()).isEqualTo(YesOrNo.NO);
    ...
    void givenAsRespondentSolicitor_whenHandled_thenSessionWrapperPopulated() {
        ...
        assertThat(finremCaseData.getSessionWrapper().getLoginAsRespondentSolicitor()).isEqualTo(YesOrNo.YES);
