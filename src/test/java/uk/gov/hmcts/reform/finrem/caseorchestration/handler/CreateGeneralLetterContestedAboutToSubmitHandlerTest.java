...
public class CreateGeneralLetterContestedAboutToSubmitHandlerTest {
    ...
    private FinremCallbackRequest buildFinremCallbackRequest() {
        ...
        return FinremCallbackRequest.<FinremCaseDataContested>builder().eventType(EventType.CREATE_GENERAL_LETTER).caseDetails(caseDetails).build();
    }
