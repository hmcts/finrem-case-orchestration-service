...
public class IntervenerTwoWithoutPrejudiceOffersDocumentsHandlerTest extends BaseManageDocumentsHandlerTest {

    @InjectMocks
    IntervenerTwoWithoutPrejudiceOffersDocumentHandler collectionService;


    @Override
    public void setUpscreenUploadDocumentList() {
        screenUploadDocumentList.add(createContestedUploadDocumentItem(CaseDocumentType.WITHOUT_PREJUDICE_OFFERS,
            CaseDocumentParty.INTERVENER_TWO, YesOrNo.NO, YesOrNo.NO, "Other Example"));
    }
