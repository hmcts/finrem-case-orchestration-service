...
public class RespondentFormEExhibitsCollectionServiceTest extends CaseDocumentCollectionsServiceTest {

    @InjectMocks
    RespondentFormEExhibitsCollectionService collectionService;
