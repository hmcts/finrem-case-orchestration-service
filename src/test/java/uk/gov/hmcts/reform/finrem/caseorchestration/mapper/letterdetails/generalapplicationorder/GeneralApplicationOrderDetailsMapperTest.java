...
public class GeneralApplicationOrderDetailsMapperTest extends ContestedContestedAbstractLetterDetailsMapperTest {

    public static final String TEST_JSON = "/fixtures/general-application-directions.json";

    @Autowired
    private GeneralApplicationOrderDetailsMapperContested generalApplicationOrderDetailsMapper;
