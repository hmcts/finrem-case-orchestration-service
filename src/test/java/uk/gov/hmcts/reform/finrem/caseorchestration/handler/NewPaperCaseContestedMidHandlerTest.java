...
public class NewPaperCaseContestedMidHandlerTest {

    public static final String AUTH_TOKEN = "tokien:)";
    private NewPaperCaseContestedMidHandler handler;
    ...
    public void setup() {
        ...
        handler =  new NewPaperCaseContestedMidHandler(service);
    }
    ...
    @Test
    public void givenConsentedCase_whenEventIsAIssueAppAndCallbackIsSubmitted_thenHandlerCanNotHandle() {
        assertThat(handler
