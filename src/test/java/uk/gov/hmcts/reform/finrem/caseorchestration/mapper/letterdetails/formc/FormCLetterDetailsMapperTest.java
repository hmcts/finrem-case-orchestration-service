...
public class FormCLetterDetailsMapperTest extends AbstractLetterDetailsMapperTest {
    ...
    private FormCLetterDetails getExpectedFormCLetterDetails() {
        return FormCLetterDetails.builder()
            ...
            .hearingDateLess28Days(String.valueOf(HEARING_DATE.minusDays(28)))
            .hearingDateLess21Days(String.valueOf(HEARING_DATE.minusDays(21)))
            .hearingDateLess14Days(String.valueOf(HEARING_DATE.minusDays(14)))
            .hearingDateLess7Days(String.valueOf(HEARING_DATE.minusDays(7)))
