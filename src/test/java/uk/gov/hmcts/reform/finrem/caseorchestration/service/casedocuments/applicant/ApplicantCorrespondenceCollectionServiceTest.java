...
public class ApplicantCorrespondenceCollectionServiceTest extends CaseDocumentCollectionsServiceTest {

    @InjectMocks
    ApplicantCorrespondenceCollectionService collectionService;
    ...
    public void givenAddedDocOnScreenCollectionWhenAddNewOrMovedDocumentToCollectionThenAddScreenDocsToCollectionType() {
        ...
        assertThat(caseData.getUploadCaseDocumentWrapper()
                .getDocumentCollection(ManageCaseDocumentsCollectionType.APP_CORRESPONDENCE_COLLECTION),
            hasSize(2));
