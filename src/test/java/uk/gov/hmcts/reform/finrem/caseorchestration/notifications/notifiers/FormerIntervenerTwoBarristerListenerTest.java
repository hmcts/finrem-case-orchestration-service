...
class FormerIntervenerTwoBarristerListenerTest extends BasePartyListenerTest {

    @InjectMocks
    private FormerIntervenerTwoBarristerListener underTest;
    ...
    @EnumSource(value = NotificationParty.class, mode = EnumSource.Mode.EXCLUDE, names = {
        "FORMER_INTERVENER_TWO_BARRISTER_ONLY"
    })
