...
public class CreateGeneralLetterContestedMidHandlerTest {

    private CreateGeneralLetterContestedMidHandler handler;
    ...
    @Before
    public void setup() {
        handler = new CreateGeneralLetterContestedMidHandler(finremCaseDetailsMapper, generalLetterService);
    }
    ...
    public void givenACcdCallbackCallbackCreateGeneralLetterAboutToSubmitHandler_WhenHandle_thenCreateError() {
        FinremCallbackRequest<FinremCaseDataContested> callbackRequest = buildFinremCallbackRequest();
