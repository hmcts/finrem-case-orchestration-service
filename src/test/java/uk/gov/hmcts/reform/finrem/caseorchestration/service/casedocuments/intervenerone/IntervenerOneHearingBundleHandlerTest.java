...
public class IntervenerOneHearingBundleHandlerTest extends BaseManageDocumentsHandlerTest {

    @InjectMocks
    IntervenerOneHearingBundleHandler handler;
    ...
    public void givenAddedDocOnScreenCollectionWhenAddNewOrMovedDocumentToCollectionThenAddScreenDocsToCollectionType() {
        ...
        assertThat(caseData.getUploadCaseDocumentWrapper()
                .getDocumentCollectionPerType(CaseDocumentCollectionType.INTERVENER_ONE_HEARING_BUNDLES_COLLECTION),
            hasSize(1));
