...
public class IntervenerFourWithoutPrejudiceOffersDocumentsHandlerTest extends BaseManageDocumentsHandlerTest {

    @InjectMocks
    IntervenerFourWithoutPrejudiceOffersDocumentHandler collectionService;


    @Override
    public void setUpscreenUploadDocumentList() {
        screenUploadDocumentList.add(createContestedUploadDocumentItem(CaseDocumentType.WITHOUT_PREJUDICE_OFFERS,
            CaseDocumentParty.INTERVENER_FOUR, YesOrNo.NO, YesOrNo.NO, "Other Example"));
    }
