...
public class ApplicantExpertEvidenceHandlerTest extends CaseDocumentManagerTest {

    ApplicantExpertEvidenceManager applicantExpertEvidenceHandler = new ApplicantExpertEvidenceManager(new ObjectMapper());
    ...
    public void appExpertEvidenceFiltered() {
        ...
        applicantExpertEvidenceHandler.manageDocumentCollection(uploadDocumentList, caseData);
