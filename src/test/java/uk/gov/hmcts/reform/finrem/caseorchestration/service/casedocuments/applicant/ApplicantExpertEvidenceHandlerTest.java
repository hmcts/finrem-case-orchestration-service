...
public class ApplicantExpertEvidenceHandlerTest extends CaseDocumentCollectionsManagerTest {

    ApplicantExpertEvidenceCollectionService applicantExpertEvidenceHandler = new ApplicantExpertEvidenceCollectionService(new ObjectMapper());
    ...
    public void appExpertEvidenceFiltered() {
        ...
        applicantExpertEvidenceHandler.processUploadDocumentCollection(caseData);
