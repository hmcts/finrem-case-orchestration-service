...
public class RespondentCaseSummariesCollectionServiceTest extends CaseDocumentCollectionsServiceTest {
    ...
    public void givenAddedDocOnScreenCollectionWhenAddNewOrMovedDocumentToCollectionThenAddScreenDocsToCollectionType() {
        ...
        assertThat(caseData.getUploadCaseDocumentWrapper()
                .getDocumentCollection(ManageCaseDocumentsCollectionType.RESP_CASE_SUMMARIES_COLLECTION),
            hasSize(3));
