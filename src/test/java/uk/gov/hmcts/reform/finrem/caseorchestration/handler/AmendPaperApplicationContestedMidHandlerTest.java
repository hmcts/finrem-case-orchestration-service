...
public class AmendPaperApplicationContestedMidHandlerTest {

    public static final String AUTH_TOKEN = "tokien:)";
    private AmendPaperApplicationContestedMidHandler handler;
    ...
    public void setup() {
        ...
        handler =  new AmendPaperApplicationContestedMidHandler(service);
    }
    ...
    public void givenContestedCase_whenEventIsAmend_thenHandlerCanHandle() {
        assertThat(handler
                .canHandle(CallbackType.MID_EVENT, CaseType.CONTESTED, EventType.AMEND_CONTESTED_PAPER_APP_DETAILS),
            is(true));
    }
    ...
    @Test
    public void givenContestedPaperCase_whenChildLivesInEnglandOrWales_thenHandlerCanHandle() {
        CallbackRequest callbackRequest = buildCallbackRequest();
