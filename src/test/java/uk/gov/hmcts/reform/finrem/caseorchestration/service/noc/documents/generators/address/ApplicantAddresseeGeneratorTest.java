...
public class ApplicantAddresseeGeneratorTest {
    ...
    protected static final Map<String, Object> APPLICANT_ADDRESS_VALUE = Map.of("AddressLine1", "Applicant address line 1");
    ...
    public void shouldBuildApplicantAddressee() {
        ...
        when(caseDataService.buildFullName(caseData, APPLICANT_FIRST_MIDDLE_NAME, APPLICANT_LAST_NAME)).thenReturn(
            APPLICANT_FULL_NAME);
        when(documentHelper.formatAddressForLetterPrinting(APPLICANT_ADDRESS_VALUE, false)).thenReturn(FORMATTED_ADDRESS);
        ...
        verify(postalService).isApplicantResideOutsideOfUK(caseData);
    }
}
