...
public class IntervenerTwoFdrDocumentCategoriserTest {

    private final IntervenerTwoFdrDocumentCategoriser categoriser = new IntervenerTwoFdrDocumentCategoriser();

    @Test
    public void testGetDocumentCategory() {
        assertEquals(DocumentCategory.FDR_DOCUMENTS_AND_FDR_BUNDLE_INTERVENER_2_POSITION_STATEMENTS,
        ...
        assertEquals(DocumentCategory.FDR_DOCUMENTS_AND_FDR_BUNDLE_INTERVENER_2_WITHOUT_PREJUDICE_OFFERS,
        ...
        assertEquals(DocumentCategory.FDR_DOCUMENTS_AND_FDR_BUNDLE_INTERVENER_2_POINTS_OF_CLAIM_OR_DEFENCE,
