...
class ApplicantSolicitorListenerTest extends BasePartyListenerTest {

    @InjectMocks
    private ApplicantSolicitorListener underTest;

    @ParameterizedTest
    @EnumSource(value = NotificationParty.class, mode = EnumSource.Mode.EXCLUDE, names = {"APPLICANT_SOLICITOR_ONLY"})
    ...
    @Test
    void shouldNotSendEmailNotificationIfCaseDetailsIsAbsent() {
        FinremCaseDetails caseDetails = null;
        FinremCaseDetails caseDetailsBefore = null;

        SendCorrespondenceEvent event = sendCorrespondenceEventWithTargetNotificationParty(caseDetails,
