...
class SolicitorCreateConsentedSubmittedHandlerTest {
    ...
    @Test
    void givenACcdCallbackSolicitorCreateConsentedCase_WhenCanHandleCalled_thenHandlerCanHandle() {
        assertThat(handler
    ...
    @Test
    void givenACcdCallbackSolicitorCreateConsentedCase_WhenHandleWithAppRepresentation_thenAddSupplementaryAndAppRep() {
    ...
    @Test
    void givenACcdCallbackSolicitorCreateConsentedCase_WhenHandleWithAppRepresentationError_thenAddSupplementaryAndHandleException() {
        FinremCallbackRequest callbackRequest = buildFinremCallbackRequest(YesOrNo.YES);
    ...
    @Test
    void givenACcdCallbackSolicitorCreateConsentedCase_WhenHandleWithNoAppRepresentation_thenApplicantSolicitorNotAssigned() {
