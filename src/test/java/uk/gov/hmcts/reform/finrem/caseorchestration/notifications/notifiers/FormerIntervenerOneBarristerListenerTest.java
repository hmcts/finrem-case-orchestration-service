...
class FormerIntervenerOneBarristerListenerTest extends BasePartyListenerTest {

    @InjectMocks
    private FormerIntervenerOneBarristerListener underTest;
    ...
    @EnumSource(value = NotificationParty.class, mode = EnumSource.Mode.EXCLUDE, names = {
        "FORMER_INTERVENER_ONE_BARRISTER_ONLY"
    })
