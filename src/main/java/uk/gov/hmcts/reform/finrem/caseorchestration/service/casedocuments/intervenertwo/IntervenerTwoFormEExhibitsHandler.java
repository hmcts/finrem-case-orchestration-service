...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.ManageCaseDocumentsCollectionType.INTV_TWO_FORM_E_EXHIBITS_COLLECTION;
...
public class IntervenerTwoFormEExhibitsHandler extends FormEExhibitsHandler {
    ...
    public IntervenerTwoFormEExhibitsHandler() {
        super(INTV_TWO_FORM_E_EXHIBITS_COLLECTION, INTERVENER_TWO);
    }
