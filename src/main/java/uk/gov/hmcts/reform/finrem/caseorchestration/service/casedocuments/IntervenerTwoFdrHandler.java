...
@Service
public class IntervenerTwoFdrHandler extends PartyDocumentHandler {

    public IntervenerTwoFdrHandler() {
        super(ManageCaseDocumentsCollectionType.INTV_TWO_FDR_DOCS_COLLECTION, CaseDocumentParty.INTERVENER_TWO);
    }
