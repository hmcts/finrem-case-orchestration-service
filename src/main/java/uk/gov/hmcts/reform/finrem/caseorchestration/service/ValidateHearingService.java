...
public class ValidateHearingService {
    ...
    public List<String> validateManageHearingWarnings(FinremCaseData caseData, InterimTypeOfHearing hearingType) {
        // TODO: add logic for checking hearing times for FDA and FDR.
