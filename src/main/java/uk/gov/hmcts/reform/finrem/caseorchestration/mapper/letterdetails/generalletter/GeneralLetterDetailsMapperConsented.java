...
@Component
public class GeneralLetterDetailsMapperConsented extends ConsentedAbstractLetterDetailsMapper {

    public GeneralLetterDetailsMapperConsented(CourtDetailsMapper courtDetailsMapper, ObjectMapper objectMapper) {
