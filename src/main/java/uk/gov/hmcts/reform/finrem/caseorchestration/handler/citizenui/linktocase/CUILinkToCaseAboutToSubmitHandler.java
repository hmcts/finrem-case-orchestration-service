...
public abstract class CUILinkToCaseAboutToSubmitHandler extends FinremCallbackHandler {
    ...
    private void assignCitizenCaseRole(FinremCallbackRequest callbackRequest,
        ...
        String userId = getCitizenIdamUserIdFromAccessCode(mergedAccessCodes)
    ...
    private Optional<String> getCitizenIdamUserIdFromAccessCode(List<AccessCodeCollection> mergedAccessCodes) {
