...
public class ManageScannedDocsContestedAboutToSubmitHandler extends FinremCallbackHandler {
    ...
    private void getValidatedResponse(FinremCaseData caseData, List<String> warnings) {
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(caseData.getIntervenerOne().getIntervenerName())
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(caseData.getIntervenerTwo().getIntervenerName())
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(caseData.getIntervenerThree().getIntervenerName())
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(caseData.getIntervenerFour().getIntervenerName())
