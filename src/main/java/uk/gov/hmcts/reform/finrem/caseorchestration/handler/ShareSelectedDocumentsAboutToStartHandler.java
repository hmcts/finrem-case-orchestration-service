...
@Slf4j
@Service
public class ShareSelectedDocumentsAboutToStartHandler extends FinremCallbackHandler<FinremCaseDataContested> {
    ...
    private boolean validateSourceDocments(FinremCaseDataContested caseData,
                                           DynamicMultiSelectList sourceDocumentList,
                                           String party,
                                           Long caseId) {
        String logMessage = "party {} for caseId {}";
