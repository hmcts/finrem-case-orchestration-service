...
@Component
public class SuggestedDraftOrdersCategoriser extends DocumentCategoriser {

    public SuggestedDraftOrdersCategoriser(FeatureToggleService featureToggleService) {
