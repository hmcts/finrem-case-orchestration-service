...
public class GeneralLetterService {
    ...
    private UUID printLatestGeneralLetter(CaseDetails caseDetails, String auth) {
        ...
        return bulkPrintService.sendDocumentForPrint(latestGeneralLetterData.getGeneralLetter().getGeneratedLetter(), caseDetails, auth);
    }
}
