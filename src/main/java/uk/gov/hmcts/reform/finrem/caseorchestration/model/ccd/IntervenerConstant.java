...
public class IntervenerConstant {
    ...
    public static final String ADD_INTERVENER_ONE_CODE = "addIntervener1";
    public static final String ADD_INTERVENER_TWO_CODE = "addIntervener2";
    ...
    public static final String ADD_INTERVENER_ONE_VALUE = "Add/Amend Intervener1";
    public static final String ADD_INTERVENER_TWO_VALUE = "Add/Amend Intervener2";
    public static final String ADD_INTERVENER_THREE_VALUE = "Add/Amend Intervener3";
    public static final String ADD_INTERVENER_FOUR_VALUE = "Add/Amend Intervener4";
    ...
    public static final String DEL_INTERVENER_THREE_CODE = "delIntervener3";
    public static final String DEL_INTERVENER_FOUR_CODE = "delIntervener4";

    public static final String DEL_INTERVENER_ONE_VALUE = "Delete Intervener1";
    public static final String DEL_INTERVENER_TWO_VALUE = "Delete Intervener2";
