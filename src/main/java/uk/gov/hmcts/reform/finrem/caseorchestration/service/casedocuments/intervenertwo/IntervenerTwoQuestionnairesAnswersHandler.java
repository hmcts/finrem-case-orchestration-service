...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.ManageCaseDocumentsCollectionType.INTV_TWO_QUESTIONNAIRES_ANSWERS_COLLECTION;
...
public class IntervenerTwoQuestionnairesAnswersHandler extends QuestionnairesAnswersHandler {
    ...
    public IntervenerTwoQuestionnairesAnswersHandler() {
        super(INTV_TWO_QUESTIONNAIRES_ANSWERS_COLLECTION, INTERVENER_TWO);
    }
}
