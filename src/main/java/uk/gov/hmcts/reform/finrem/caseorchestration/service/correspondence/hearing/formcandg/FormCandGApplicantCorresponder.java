...
@Component
@Slf4j
public class FormCandGApplicantCorresponder extends MultiLetterOrEmailApplicantCorresponder {

    private final DocumentHelper documentHelper;
    private final ObjectMapper objectMapper;

    @Autowired
    public FormCandGApplicantCorresponder(NotificationService notificationService,
