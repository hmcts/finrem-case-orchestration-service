...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.ManageCaseDocumentsCollectionType.INTV_ONE_EVIDENCE_COLLECTION;
...
public class IntervenerOneExpertEvidenceHandler extends ExpertEvidenceHandler {
    ...
    public IntervenerOneExpertEvidenceHandler() {
        super(INTV_ONE_EVIDENCE_COLLECTION, INTERVENER_ONE);
    }
}
