...
@Slf4j
@Service
public class ManageCaseDocumentsContestedAboutToStartHandler extends FinremCallbackHandler<FinremCaseDataContested> {
    ...
    private void migrateLegacyConfidentialCaseDocumentFormat(FinremCaseDataContested data) {
    ...
    private void populateMissingConfidentialFlag(FinremCaseDataContested caseData) {
