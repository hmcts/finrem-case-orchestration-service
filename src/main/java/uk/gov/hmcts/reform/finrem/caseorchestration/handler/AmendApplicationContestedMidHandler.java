...
public class AmendApplicationContestedMidHandler implements CallbackHandler<Map<String, Object>> {
    ...
    public GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> handle(CallbackRequest callbackRequest,
        ...
        log.info("Received request for mid callback event {} for caseid {}",
                EventType.AMEND_CONTESTED_APP_DETAILS, callbackRequest.getCaseDetails().getId());
