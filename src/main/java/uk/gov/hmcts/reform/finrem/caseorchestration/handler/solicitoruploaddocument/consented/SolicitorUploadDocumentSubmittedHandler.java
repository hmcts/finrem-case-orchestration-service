...
@Slf4j
@Service
public class SolicitorUploadDocumentSubmittedHandler extends FinremSubmittedCallbackHandler {

    public SolicitorUploadDocumentSubmittedHandler(FinremCaseDetailsMapper finremCaseDetailsMapper,
