...
public class InvalidateApplicantAccessCodeAboutToSubmitHandler extends FinremCallbackHandler {
    ...
    public InvalidateApplicantAccessCodeAboutToSubmitHandler(FinremCaseDetailsMapper finremCaseDetailsMapper, InvalidateAccessCodeService invalidateAccessCodeService) {
