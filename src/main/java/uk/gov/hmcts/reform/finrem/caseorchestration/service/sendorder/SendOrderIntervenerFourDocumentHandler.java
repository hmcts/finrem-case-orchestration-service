...
public class SendOrderIntervenerFourDocumentHandler extends SendOrderPartyDocumentHandler {
    ...
    protected void setConsolidateCollection(FinremCaseData caseData, List<ApprovedOrderCollection> orderCollection) {
        ...
        List<ApprovedOrderConsolidateCollection> orders =
            getPartyConsolidateCollection(caseData.getOrderWrapper().getIntv4OrderCollections());
    ...
    protected String getSupportingDocumentsCategoryId() {
        return DocumentCategory.INTERVENER_DOCUMENTS_INTERVENER_4_SUPPORTING_DOCUMENTS.getDocumentCategoryId();
    }
}
