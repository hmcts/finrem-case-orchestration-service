...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.ManageCaseDocumentsCollectionType.INTV_THREE_OTHER_COLLECTION;
...
public class IntervenerThreeOtherDocumentsHandler extends OtherDocumentsHandler {
    ...
    public IntervenerThreeOtherDocumentsHandler() {
        super(INTV_THREE_OTHER_COLLECTION, INTERVENER_THREE);
    }
}
