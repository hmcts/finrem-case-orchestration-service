...
@Slf4j
@Service
public class SuggestedDraftOrdersAboutToStartHandler extends FinremCallbackHandler {

    public SuggestedDraftOrdersAboutToStartHandler(FinremCaseDetailsMapper finremCaseDetailsMapper) {
