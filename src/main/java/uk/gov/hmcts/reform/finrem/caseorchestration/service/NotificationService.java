...
public class NotificationService {
    ...
    public void sendContestedOutstandingOrdersNeedReviewEmailToCaseworker(FinremCaseDetails caseDetails, DraftOrderReview draftOrderReview) {
        NotificationRequest notificationRequest = finremNotificationRequestMapper
            .getNotificationRequestForOutstandingOrdersNeedReview(caseDetails, getRecipientEmail(caseDetails), draftOrderReview);
