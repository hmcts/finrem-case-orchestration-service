...
@Component
@Slf4j
public class IntervenerFourLetterAddresseeGenerator extends IntervenerLetterAddresseeGenerator<IntervenerFourWrapper> {
    ...
    @Override
    protected IntervenerFourWrapper getIntervenerWrapper(FinremCaseDetails<FinremCaseDataContested> caseDetails) {
