...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.ManageCaseDocumentsCollectionType.INTV_ONE_QUESTIONNAIRES_ANSWERS_COLLECTION;
...
public class IntervenerOneQuestionnairesAnswersHandler extends QuestionnairesAnswersHandler {
    ...
    public IntervenerOneQuestionnairesAnswersHandler() {
        super(INTV_ONE_QUESTIONNAIRES_ANSWERS_COLLECTION, INTERVENER_ONE);
    }
}
