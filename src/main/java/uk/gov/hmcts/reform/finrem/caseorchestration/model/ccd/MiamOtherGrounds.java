...
@ComplexType(name = "FR_ms_MIAMOtherGroundsChecklist", generate = true)
...
public enum MiamOtherGrounds {
    ...
    @CCD(label = "The applicant is bankrupt evidenced by a bankruptcy order in respect of the prospective applicant.")
    ...
    @CCD(label = "A child is one of the prospective parties.")
    ...
    @CCD(
            label = "(i) the prospective applicant is not able to attend a MIAM online or by video-link and an explanation of why this is the case is provided to the court using the text field provided; and\n(ii) the prospective applicant has contacted as many authorised family mediators as have an office within fifteen miles of his or her home (or five of them if there are five or more), and all of them have stated that they are not available to conduct a MIAM within fifteen business days of the date of contact; and\n(iii) the names, postal addresses and telephone numbers or e-mail addresses for the authorised family mediators contacted by the prospective applicant, and the dates of contact, are provided to the court in the text field provided."
    )
    ...
    @CCD(
            label = "(i) the prospective applicant is not able to attend a MIAM online or by video-link and an explanation of why this is the case is provided to the court using the text field provided; and\n(ii) the prospective applicant is subject to a disability or other inability that would prevent attendance in person at a MIAM unless appropriate facilities can be offered by an authorised mediator; and\n(iii) the prospective applicant has contacted as many authorised family mediators as have an office within fifteen miles of his or her home (or five of them if there are five or more), and all have stated that they are unable to provide such facilities; and\n(iv) the names, postal addresses and telephone numbers or e-mail addresses for such authorised family mediators, and the dates of contact, are provided to the court using the text field provided."
    )
    ...
    @CCD(
            label = "(i) the prospective applicant is not able to attend a MIAM online or by video-link; and\n(ii) there is no authorised family mediator with an office within fifteen miles of the prospective applicant’s home; and\n(iii) an explanation of why this exemption applies is provided by the prospective applicant to the court using the text field provided."
    )
    ...
    @CCD(
            label = "The prospective applicant cannot attend a MIAM because the prospective applicant is\n(i) in prison or any other institution in which the prospective applicant is required to be detained and facilities cannot be made available for them to attend a MIAM online or by video link; or\n(ii) subject to conditions of bail that prevent contact with the other person; or\n(iii) subject to a licence with a prohibited contact requirement in relation to the other person."
    )
