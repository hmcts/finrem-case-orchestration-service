...
public enum MiamOtherGrounds {
    ...
    FR_MS_MIAM_OTHER_GROUNDS_CHECKLIST_VALUE_8("FR_ms_MIAMOtherGroundsChecklist_Value_8",
        "Do not use after 29/04/2024 - The prospective applicant or all of the prospective respondents are not "
    ...
    FR_MS_MIAM_OTHER_GROUNDS_CHECKLIST_VALUE_10("FR_ms_MIAMOtherGroundsChecklist_Value_10",
        "Do not use after 29/04/2024 - (i) the prospective applicant has contacted as many authorised family "
            + "mediators as have an office within fifteen miles of his or her home (or three of them if there are three "
            + "or more), and all of them have stated that they are not available to conduct a "
            + "MIAM within fifteen business days of the date of contact; and (ii) the names, postal addresses and "
            + "telephone numbers or e-mail addresses for"
            + " such authorised family mediators, and the dates of contact, can be provided to the court if requested."),
