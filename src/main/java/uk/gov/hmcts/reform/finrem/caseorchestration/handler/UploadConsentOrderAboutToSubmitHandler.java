...
@Slf4j
@Service
public class UploadConsentOrderAboutToSubmitHandler extends FinremCallbackHandler {
    ...
    public UploadConsentOrderAboutToSubmitHandler(FinremCaseDetailsMapper finremCaseDetailsMapper,
