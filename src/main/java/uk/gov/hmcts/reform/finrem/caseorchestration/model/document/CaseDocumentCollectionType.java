...
public enum CaseDocumentCollectionType {
    ...
    INTERVENER_THREE_FDR_DOCS_COLLECTION("intv3FdrCaseDocuments"),
    INTERVENER_FOUR_FDR_DOCS_COLLECTION("intv4FdrCaseDocuments"),
    CONFIDENTIAL_DOCS_COLLECTION("confidentialDocumentCollection");
