...
public enum NotificationParty {
    ...
    CUI_APPLICANT("CUI_APPLICANT", DO_NOT_NOTIFY_REPRESENTED, DO_NOT_NOTIFY_FORMER_PARTY),
    CUI_RESPONDENT("CUI_RESPONDENT", DO_NOT_NOTIFY_REPRESENTED, DO_NOT_NOTIFY_FORMER_PARTY);
