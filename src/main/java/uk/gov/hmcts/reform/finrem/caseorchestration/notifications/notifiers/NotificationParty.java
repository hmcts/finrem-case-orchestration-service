...
public enum NotificationParty {
    ...
    CITIZEN_APPLICANT("CITIZEN_APPLICANT", DO_NOT_NOTIFY_REPRESENTED, DO_NOT_NOTIFY_FORMER_PARTY),
    CITIZEN_RESPONDENT("CITIZEN_RESPONDENT", DO_NOT_NOTIFY_REPRESENTED, DO_NOT_NOTIFY_FORMER_PARTY),
