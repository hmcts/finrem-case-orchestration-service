...
public class CCDConfigConstant {
    ...
    public static final String SOLICITOR_AGREE_TO_RECEIVE_EMAILS_CONTESTED = "solicitorAgreeToReceiveEmails";
    public static final String SOLICITOR_AGREE_TO_RECEIVE_EMAILS_CONSENTED = "applicantSolicitorConsentForEmails";
