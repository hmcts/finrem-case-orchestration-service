...
@Component
public abstract class ContestedAbstractLetterDetailsMapper {
    ...
    protected ContestedAbstractLetterDetailsMapper(CourtDetailsMapper courtDetailsMapper, ObjectMapper objectMapper) {
        this.courtDetailsMapper = courtDetailsMapper;
        this.objectMapper = objectMapper;
        objectMapper.registerModule(new JavaTimeModule());
    }

    public abstract DocumentTemplateDetails buildDocumentTemplateDetails(FinremCaseDetails<FinremCaseDataContested> caseDetails,
                                                                         CourtListWrapper courtList);

    public Map<String, Object> getDocumentTemplateDetailsAsMap(FinremCaseDetails<FinremCaseDataContested> caseDetails,
                                                               CourtListWrapper courtList) {
