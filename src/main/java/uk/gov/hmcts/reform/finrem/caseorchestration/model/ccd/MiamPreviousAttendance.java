...
public enum MiamPreviousAttendance {
    ...
    FR_MS_MIAM_PREVIOUS_ATTENDANCE_CHECKLIST_VALUE_4("FR_ms_MIAMPreviousAttendanceChecklist_Value_4",
        "Do not use after 29/04/2024 - The application would be made in existing proceedings which are continuing and the prospective applicant attended a MIAM before initiating those proceedings"),
    FR_MS_MIAM_PREVIOUS_ATTENDANCE_CHECKLIST_VALUE_5("FR_ms_MIAMPreviousAttendanceChecklist_Value_5",
        "Do not use after 29/04/2024 - The application would be made in existing proceedings which are continuing and a MIAM exemption applied to the application for those proceedings");
