...
@Component
@Slf4j
public class UpdateFrcRespondentCorresponder extends SingleLetterOrEmailRespondentCorresponder {

    private final UpdateFrcInfoRespondentDocumentService updateFrcInfoRespondentDocumentService;

    @Autowired
    public UpdateFrcRespondentCorresponder(BulkPrintService bulkPrintService,
