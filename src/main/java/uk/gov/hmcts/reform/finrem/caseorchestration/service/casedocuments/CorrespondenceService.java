...
public class CorrespondenceService extends PartyDocumentCollectionService {

    public CorrespondenceService(ManageCaseDocumentsCollectionType manageCaseDocumentsCollectionType,
