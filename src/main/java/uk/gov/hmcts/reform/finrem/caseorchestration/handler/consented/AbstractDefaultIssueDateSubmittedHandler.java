...
public abstract class AbstractDefaultIssueDateSubmittedHandler extends FinremSubmittedCallbackHandler {
    ...
    protected AbstractDefaultIssueDateSubmittedHandler(FinremCaseDetailsMapper finremCaseDetailsMapper,
