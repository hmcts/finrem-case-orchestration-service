...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_APPLICANT;
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_INTERVENER_1;
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_INTERVENER_2;
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_INTERVENER_3;
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_INTERVENER_4;
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_OTHER;
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.DocumentCategory.COURT_CORRESPONDENCE_RESPONDENT;
    ...
    private String getGeneratedLetterCategoryId(String roleCode) {
        switch (roleCode) {
            case APPLICANT, APPLICANT_SOLICITOR -> {
                return COURT_CORRESPONDENCE_APPLICANT.getDocumentCategoryId();
            }
            case RESPONDENT, RESPONDENT_SOLICITOR -> {
                return COURT_CORRESPONDENCE_RESPONDENT.getDocumentCategoryId();
            }
            case INTERVENER1, INTERVENER1_SOLICITOR -> {
                return COURT_CORRESPONDENCE_INTERVENER_1.getDocumentCategoryId();
            }
            case INTERVENER2, INTERVENER2_SOLICITOR -> {
                return COURT_CORRESPONDENCE_INTERVENER_2.getDocumentCategoryId();
            }
            case INTERVENER3, INTERVENER3_SOLICITOR -> {
                return COURT_CORRESPONDENCE_INTERVENER_3.getDocumentCategoryId();
            }
            case INTERVENER4, INTERVENER4_SOLICITOR -> {
                return COURT_CORRESPONDENCE_INTERVENER_4.getDocumentCategoryId();
            }
            default -> {
                return COURT_CORRESPONDENCE_OTHER.getDocumentCategoryId();
            }
        }
    }
}
