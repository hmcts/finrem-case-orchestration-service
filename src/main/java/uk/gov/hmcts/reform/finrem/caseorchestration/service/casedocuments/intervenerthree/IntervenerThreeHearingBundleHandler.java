...
import static uk.gov.hmcts.reform.finrem.caseorchestration.model.document.ManageCaseDocumentsCollectionType.INTV_THREE_HEARING_BUNDLES_COLLECTION;
...
public class IntervenerThreeHearingBundleHandler extends HearingBundleHandler {
    ...
    public IntervenerThreeHearingBundleHandler() {
        super(INTV_THREE_HEARING_BUNDLES_COLLECTION, INTERVENER_THREE);
    }
}
