...
public enum EstimatedAsset {
    ...
    ONE_TO_SEVEN_POINT_FIVE_MILLION("estimatedAssetsChecklist_3"),
    SEVEN_POINT_FIVE_TO_FIFTEEN_MILLION("estimatedAssetsChecklist_4"),
    OVER_FIFTEEN_MILLION("estimatedAssetsChecklist_5");
