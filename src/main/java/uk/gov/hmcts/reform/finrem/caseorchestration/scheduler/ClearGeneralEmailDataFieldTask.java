...
public class ClearGeneralEmailDataFieldTask extends CsvFileProcessingTask {
    public static final String CASE_LIST_FILE = "caserefs-for-dfr-3639.csv";
    ...
    @Value("${cron.clearGeneralEmailDataFieldTask.batchSize:5}")
    ...
    protected List<CaseReference> getCaseReferences() {
        ...
        // TODO function to get decrypt keys from Azure Key Vault
    ...
    protected void executeTask(FinremCaseDetails finremCaseDetails) {
        ...
        CaseDocument generalEmailUploadedDocument = caseData.getGeneralEmailWrapper().getGeneralEmailUploadedDocument();

        if (generalEmailUploadedDocument != null
            && (!generalEmailUploadedDocument.getDocumentFilename().isEmpty()
            || !generalEmailUploadedDocument.getDocumentBinaryUrl().isEmpty())) {
