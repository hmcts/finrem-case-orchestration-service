...
@ComplexType(name = "FR_ms_potentialAllegationChecklist", generate = true)
@RequiredArgsConstructor
public enum PotentialAllegation {
    @CCD(label = "Pre- or post-nuptial agreements")
    POTENTIAL_ALLEGATION_CHECKLIST_1("potentialAllegationChecklist_1",
        "Pre- or post-nuptial agreements"),
    @CCD(label = "Complex asset or income structures")
    ...
    @CCD(label = "The value of family assets, trust and/or corporate entities")
    ...
    @CCD(label = "There may be substantial arguments about the parties’ respective contributions")
    ...
    @CCD(label = "There are/may be disputed allegations of “obvious and gross” conduct")
    ...
    @CCD(label = "The case involves an application under Schedule 1 Children Act 1989")
    ...
    @CCD(label = "The application involves a complex or novel legal argument")
    ...
    @CCD(label = "There is likely to be a need for the involvement of Intervenors")
    ...
    @CCD(label = "The case involves an insolvency issue")
