...
@Slf4j
@Service
public class SolicitorAndCaseWorkerDraftOrderAboutToSubmitHandler extends FinremCallbackHandler {

    private final UploadedDraftOrderCategoriser uploadedDraftOrderCategoriser;

    public SolicitorAndCaseWorkerDraftOrderAboutToSubmitHandler(FinremCaseDetailsMapper finremCaseDetailsMapper,
