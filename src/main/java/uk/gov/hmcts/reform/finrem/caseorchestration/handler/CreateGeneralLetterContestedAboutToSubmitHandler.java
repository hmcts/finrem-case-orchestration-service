...
@Slf4j
@Service
public class CreateGeneralLetterContestedAboutToSubmitHandler extends FinremCallbackHandler {
    private final GeneralLetterService generalLetterService;

    @Autowired
    public CreateGeneralLetterContestedAboutToSubmitHandler(FinremCaseDetailsMapper mapper,
