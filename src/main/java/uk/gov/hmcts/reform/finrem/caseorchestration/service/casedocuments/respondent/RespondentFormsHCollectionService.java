...
public class RespondentFormsHCollectionService extends FormsHCollectionService {
    ...
    @Autowired
    public RespondentFormsHCollectionService(EvidenceManagementDeleteService evidenceManagementDeleteService) {
        super(ManageCaseDocumentsCollectionType.RESP_FORM_H_COLLECTION, evidenceManagementDeleteService,
