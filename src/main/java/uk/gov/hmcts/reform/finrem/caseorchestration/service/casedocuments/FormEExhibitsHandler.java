...
public class FormEExhibitsHandler extends PartyDocumentsHandler {

    public FormEExhibitsHandler(ManageCaseDocumentsCollectionType manageCaseDocumentsCollectionType,
