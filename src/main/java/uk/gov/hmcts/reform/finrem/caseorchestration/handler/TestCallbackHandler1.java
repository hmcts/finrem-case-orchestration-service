...
@Service
@Order(2)
public class TestCallbackHandler1 extends FinremCallbackHandler {
    public TestCallbackHandler1(FinremCaseDetailsMapper finremCaseDetailsMapper) {
    ...
    public GenericAboutToStartOrSubmitCallbackResponse<FinremCaseData> handle(FinremCallbackRequest callbackRequest, String userAuthorisation) {
        ...
        caseManagementLocation.setBaseLocation("TestCallbackHandler1 setting");
