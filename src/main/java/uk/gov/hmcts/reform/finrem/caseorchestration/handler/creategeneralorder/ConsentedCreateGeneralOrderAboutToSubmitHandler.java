...
@Service
@Slf4j
public class ConsentedCreateGeneralOrderAboutToSubmitHandler extends FinremCallbackHandler {

    private final GeneralOrderService generalOrderService;

    public ConsentedCreateGeneralOrderAboutToSubmitHandler(FinremCaseDetailsMapper finremCaseDetailsMapper,
