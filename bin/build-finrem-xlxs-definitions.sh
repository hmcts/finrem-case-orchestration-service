...
mv definitions/consented/xlsx/ccd-config-local-consented-wa-base.xlsx "$orchestrator_dir"/build/definitionsToBeImported/ccd-config-local-consented-base.xlsx
